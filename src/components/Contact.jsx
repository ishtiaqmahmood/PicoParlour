      ...
      >
        ...
        <div className="contact__data">
          <div className="contact__data__description">
            ...
            <div>
              <p>
                <strong>Address:</strong> Kha-2, Pahartali, Chowmoni, Raozan,
                Chattogram
              </p>
              <p>
                <strong>Email:</strong> picocoders@gmail.com
              </p>
              <p>
                <strong>Website:</strong>{' '}
                <a
                  href="https://www.picocoders.com"
                  target="_blank"
                  style={{ textDecoration: 'none', color: '#990011' }}
                >
                  www.picocoders.com
                </a>
              </p>
